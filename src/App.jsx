  ...
  return (
    <>
      <div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]">
        <h1 className=" italic mt-3 md:mt-5 text-2xl md:text-5xl font-black text-center font-poppins bg-gradient-to-r from-black to-purple-900 text-transparent bg-clip-text">
          ID Card Generator
        </h1>
        <div className="absolute bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_800px_at_100%_200px,#d5c5ff,transparent)]">
          <div className=" flex items-center justify-center min-h-screen">
            ...
            {showForm && (
              <form
                className={`w-80 mt-14 md:w-96  bg-white p-8 border border-purple-400 shadow-md rounded`}
